...
- On créer ensuite les utilisateurs des groupes avec une description et leur mots de passe. 
...
- On ajoute ensuite les utilisateurs a leur groupe respectif. 
...
- Finaliser la manœuvre en cliquant sur Créer.

- ### <ins>Comme le demande l'énoncer nous allons maintenant créer les exceptions et autres.<ins>

- Nous commencerons par ajouter les membres du services informatique au groupe Administrateurs

![image](https://user-images.githubusercontent.com/95431446/167589423-f93918d7-d574-4530-a325-7d03f6a8c8c9.png)

- Nous allons ensuite activé l'exigences de complexité pour les mots de passe et le changement obligatoire tout les 25 jours, nous utiliserons pour ce faire l'éditeur de stratégie de groupe locale en utilisant 'windows + R' nous tapons ensuite ``` gpedit.msc```

![image](https://user-images.githubusercontent.com/95431446/167590517-b0a8d876-26da-4a7c-9d60-5fa1834c6e60.png)

- Il nous faut ensuite nous rendre dans l'onglet Configuration ordinateur > Paramètres Windows > Paramètres de sécurité >  stratégie de compte > Stratégie de mot de passe : 

![image](https://user-images.githubusercontent.com/95431446/167593887-6ef0a489-dca4-4f88-aec5-e3ebb5f2536a.png)

- Longueur minimal du mot de passe à 12 : 

![image](https://user-images.githubusercontent.com/95431446/167594093-35ce3a1f-78f8-4bd6-a727-6eb9aee350f8.png)

- Durée de vie maximale du mot de passe a 25 jours : 

![image](https://user-images.githubusercontent.com/95431446/167594176-7a190cd6-6ed5-468b-b8ab-d76730007cea.png)

- Activation de l'exigence de complexité : 

![image](https://user-images.githubusercontent.com/95431446/167594529-6ef9a875-0d92-4a03-8148-4129d88d5eba.png)

 - Nous allons également contraindre les heures d’ouverture de session de notre intérimaire a l'aide de l'invite de commande.
...
- Pour finir nous allons créer le fichiers Procédures avec le règlement intérieur qui sera sur le bureau de tout les utilisateurs.

Nous allons devoir nous rendre dans ``` C:\Users\Default\Desktop ```
...
On y ajoute alors le dossier Procédures avec le règlement intérieur.
